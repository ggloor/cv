...
\begin{description}\itemsep=2pt
\item 2019, Invited Participant/Speatker, Emerging Challenges in Microbiome Data Analysis, BIRS, Banff, Canada
...
\begin{itemize}
\item H-index: 44, past 5 years 38 (Google Scholar)
\item mean iCite ratio: 2.36, past 10 years 2.67 (icite.od.nih.gov: 70\textsuperscript{th} percentile NIH funded authors,  90\textsuperscript{th} percentile of all authors)
